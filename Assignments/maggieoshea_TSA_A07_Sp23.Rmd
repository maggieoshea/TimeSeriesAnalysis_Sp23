...
energy_generation$Month <-  as.Date(energy_generation$Month , "%b %Y")
naturalgas_ts <- ts(energy_generation, start=c(year(energy_generation$Month[1]),month(energy_generation$Month[1])),
                           frequency=12)
```

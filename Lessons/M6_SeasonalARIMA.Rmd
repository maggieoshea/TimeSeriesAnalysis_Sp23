...
#This says yes, and you put lag = 12 and differences =1 because this says you are differencing your series once at lag 12 (the seasonal lag)
...
Can't compare AICs because the models are too different, though usually seasonal ARIMA would be better because it works for a constant and non-constant seasonal component 
  - the AIC seems lower for the non-seasonal ARIMA because it's not accounting for the errors in seasonal 
      - the AIC for non-seasonal model says how the model is performing on th *non-seasonal* pieces **only** so cannot be compared to model that is looking at seasonal elements as well 

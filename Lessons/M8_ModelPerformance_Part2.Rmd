...
scores <- accuracy(forecast,actual)  #store the performance metrics
head(scores)
```
...
## Arithmetic Mean
mean_temp <- meanf(y = BR_Temp_ts, h=12)
checkresiduals(mean_temp)

## Seasonal Naive
SNAIVE_temp <- snaive(BR_Temp_ts, h=12)
checkresiduals(SNAIVE_temp)

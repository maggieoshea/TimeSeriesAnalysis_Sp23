...
```{r}
#You want to remove the rows from 2011, because you don't have a full year, many ways to do this 

#one way to do this is to say you don't want the last 12 rows but you want all the columns
new_inflow <- inflow_data[1:(nobs-12),]

#another way is to specify directly in the forming of the ts object 
ts_inflow_data <- ts(inflow_data[1:960,2:(2+nhydro-1)]) #note that we are only transforming columns with inflow data, not the date columns
